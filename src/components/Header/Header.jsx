...
import logo from '../../assets/weshLogo.svg';
import logoxs from '../../assets/weshIcon.svg';
import zshmetaLogo from '../../assets/zshmetapunk.svg';
        ...
        <Grid container className={classes.grid}>
          <Grid item container xs={3} md={4} spacing="1.5rem" className={classes.gridItem}>
            ...
            <Grid item className={classes.headerLinkContainer}>
              <a className={classes.link} href="https://zshmeta.dev" target="_blank" rel="noreferrer">
                zshmeta.dev
              </a>
            </Grid>
            <Grid item className={classes.headerLinkContainer}>
          ...
          <Grid item container xs={2} md={3} spacing="1.5rem" className={`${classes.gridItem}`}>
            <Grid item className={classes.headerLinkContainer}>
              <a className={classes.link} href="https://github.com/zshmeta" target="_blank" rel="noreferrer">
                <img alt="zshmeta" src={zshmetaLogo} className={classes.logo} />
              </a>
            </Grid>
